...
from lizard_languages.erlang import branch_coverage  # Import branch_coverage to check coverage
...
class TestErlangReader(unittest.TestCase):
    ...
    def test_state_nested_end_with_dot(self):
        print("Testing state_nested_end with dot")  # Log test start
        ...
        print(f"Branch coverage: {branch_coverage}")  # Print branch coverage
